...
module Delay = 
    ...
    let initialize =         
        ...
        Mil82.PartyWorks.Delay.onStart.Value <- fun what get'time -> 
        ...
        Mil82.PartyWorks.Delay.onStop.Value <- fun () -> 
            MainWindow.form.PerformThreadSafeAction <| fun () ->
                panelDelay.Visible <- false
                panelPerformingInfo.Visible <- true
            

        Mil82.PartyWorks.Delay.onUpdate.Value <- fun start'time get'time -> 
